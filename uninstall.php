...
if( !defined( 'ABSPATH' ) && !defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	exit();
	   ...
	   if (current_user_can('delete_plugins')) {
		   $gtcn_settings = array ('gtcn_nesting_replacement','gtcn_deepest_display','gtcn_orphan_replacement','gtcn_use_styles','gtcn_jumble_count','gtcn_thank_you','gtcn_thank_you_message');
		   // Nuke the options
