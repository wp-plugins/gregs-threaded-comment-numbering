...
function gtcn_css() {
  if (get_option('gtcn_use_styles') == 1) { 
	if(@file_exists(TEMPLATEPATH.'/gtcn-css.css')) {
	  wp_register_style('gtcn-plugin', get_stylesheet_directory_uri().'/gtcn-css.css', false, '1.0.1', 'all');		
	} else {
	  wp_register_style('gtcn-plugin', plugins_url('gregs-threaded-comment-numbering/gtcn-css.css'), false, '1.0.1', 'all');
	}
	echo "\n".'<!-- Start Of Additions Generated By Greg\'s Threaded Comment Numbering Plugin 1.0.1 -->'."\n";
	wp_print_styles('gtcn-plugin');
	echo '<!-- End Of Additions Generated By Greg\'s Threaded Comment Numbering Plugin 1.0.1 -->'."\n";
  } 
  return;
} 
### Function: Thank you
