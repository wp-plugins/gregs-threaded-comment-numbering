...
function gtcn_menu() {
  add_options_page(__('Threaded Comment Numbering Options', 'gtcn-plugin'), __('Threaded Comment Numbering', 'gtcn-plugin'), 'manage_options', 'greg-threaded-comment-numbering/gtcn-options.php') ;
}
...
function gtcn_css() {
  if (get_option('gtcn_use_styles') == 1) { 
	if(@file_exists(TEMPLATEPATH.'/gtcn-css.css')) {
	  ...
	  wp_register_style('gtcn-plugin', plugins_url('greg-threaded-comment-numbering/gtcn-css.css'), false, '1.0', 'all');
	}
	echo "\n".'<!-- Start Of Additions Generated By Greg\'s Threaded Comment Numbering Plugin 1.0 -->'."\n";
	wp_print_styles('gtcn-plugin');
	echo '<!-- End Of Additions Generated By Greg\'s Threaded Comment Numbering Plugin 1.0 -->'."\n";
  } 
  return;
} 
### Function: Thank you
